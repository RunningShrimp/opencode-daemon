...
export class OpenAICompatibleChatLanguageModel implements LanguageModelV2 {
  ...
  async doGenerate(
    ...
    // reasoning content (Copilot uses reasoning_text, others use reasoning_content):
      ...
      stream: response.pipeThrough(
        new TransformStream<ParseResult<z.infer<typeof this.chunkSchema>>, LanguageModelV2StreamPart>({
          ...
          transform(chunk, controller) {
            ...
            // enqueue reasoning before text deltas (Copilot uses reasoning_text, others use reasoning_content):
  ...
  choices: z.array(
    z.object({
      message: z.object({
        ...
        // OpenAI-compatible reasoning field (minimax, zhipuai, deepseek, etc.)
